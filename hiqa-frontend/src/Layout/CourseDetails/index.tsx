...
import Breadcrumb from '../FrontContainer/Components/Breadcrumb';
...
function Index() {
  ...
  return (
    <>
      ...
      <FrontContainer>
        <Breadcrumb subtitle="NDT INSPECTOR" title="Home"></Breadcrumb>
              ...
              <div className="row">
                <div className="text-column col-lg-9 col-md-9 col-sm-12">
                  ...
                  <div className="inner-column">
                    ...
                    <p>
                      The world of search engine optimization is complex and ever-changing, but you can easily
                      understand the basics, and even a small amount of SEO knowledge can make a big difference. Free
                      SEO education is also widely available on the web, including in guides like this! (Woohoo!) This
                      guide is designed to describe all major aspects of SEO, from finding the terms and phrases
                      (keywords) that can generate qualified traffic to your website, to making your site friendly to
                      search engines, to building links and marketing the unique value of your site.Etiam pharetra erat
                      sed fermentum feugiat velit mauris egestas quam ut erat justo.
                    </p>
                    <h4>What You Will Learn</h4>
                    <p>
                      Fusce eleifend donec sapien sed phase lusa pellentesque lacus.Vivamus lorem arcu semper duiac.
                      Cras ornare arcu avamus nda leo Etiam ind arcu. Morbi justo mauris tempus pharetra interdum at
                      congue semper purus. Lorem ipsum dolor sit.The world of search engine optimization is complex and
                    ...
                    <h4>Eligibility Criteria for 100% Scholarship Examination:</h4>
                    <table className="table table-bordered mb-40">
                      <thead>
                        <tr>
                          ...
                          <th align="center">ITI</th>
                          <th align="center">DIP</th>
                          <th align="center">B.Sc.</th>
                  ...
                  <aside className="sidebar-widget info-column">
                    <div className="inner-column3">
                      ...
                      <ul className="project-info clearfix">
                        ...
                        <li>
                          <span className="icon fal fa-home-lg-alt" /> <strong>Instructor:</strong>{' '}
                        ...
                        <li>
                          <span className="icon fal fa-clock" /> <strong>Duration: </strong> <span>6 weeks</span>
                        </li>
                        <li>
                          <span className="icon fal fa-user" /> <strong>Enrolled: </strong> <span>20 students</span>
                        </li>
                        <li>
