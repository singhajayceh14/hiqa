...
const MainFrom = () => {
  ...
  return (
    ...
    >
      ...
      >
        <InputField name="firstName" label="First Name" floating type="text" style={{ width: '98%' }} />
        <InputField name="lastName" label="Last Name" floating type="password" style={{ width: '98%' }} />
